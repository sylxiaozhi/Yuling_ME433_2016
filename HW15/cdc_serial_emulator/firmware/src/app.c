...
//                        }
                ...
                e = qq - 320;
                if (e >= 240){
                    u2 = 3000 - 3000 * e * 0.6/ 320 + 3000 * (e - pe) / 1000 * 0.05 / 320; 
                }
               
                else if (e < -240){
                    u1 = 3000 + 3000 * e * 0.6 / 320 + 3000 * (e - pe) / 1000 * 0.05 / 320; 
                }
                else if (e < 240 && e > 100){
                    u2 = 3000 - 3000 * e * 0.35 / 320 + 3000 * (e - pe) / 1000 * 0.02 / 320; 

                }
                else if (e > -240 && e < -100){
                    u1 = 3000 + 3000 * e * 0.35 / 320 + 3000 * (e - pe) / 1000 * 0.02 / 320; 

                }
                else{
                    u2 = 3000 - 3000 * e * 0.3 / 320 + 3000 * (e - pe) / 1000 * 0.01 / 320;
                    u1 = 3000 + 3000 * e * 0.3 / 320 + 3000 * (e - pe) / 1000 * 0.01 / 320;
                }
